...
- Match the filesystem wrappers for `writep8`, `luamin`, and `luafmt`, including `luafmt --overwrite` for text carts. The vendored Python writer does not prompt before overwrite.

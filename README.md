...
- Remaining CLI argument and fatal-error edges, including command-specific diagnostics. Multi-file headings, ordered output/error continuation, and unsupported-extension statuses are compared with Python for working text-cart commands; mixed text/PNG paths have ordering checks.
